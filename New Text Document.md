核心内涵：超越感官的认知沉浸
卡特利奇提出的“非感知表征性沉浸”包含三个关键层次，它们共同构成了超越感官的认知沉浸体验：

表征非感知信息：游戏展现的不仅是画面和声音，更重要的是世界的规则、系统运作方式和内部逻辑等非感知信息。

激发非感知认知状态：玩家为理解并利用上述规则，会主动进行思考、推理、分析、制定策略等高阶认知活动。

产生构成性的认知参与：这种高强度的脑力活动，本身就是沉浸感的重要组成部分。玩家的认知参与与虚拟世界互动，共同构建了沉浸体验。


# 1

《Recommended Selves: Authenticity and Algorithmic Filtering》（推荐自我：真实性与算法过滤），作者是Etienne Brown。
https://www.cambridge.org/core/journals/journal-of-the-american-philosophical-association/article/recommended-selves-authenticity-and-algorithmic-filtering/9036574F37705334A97932BC309AC53C

>我不只是有某个欲望；我审视了这个欲望，并决定它是否代表"我想要成为的那个人"。如果答案是肯定的，我就拥抱它；如果是否定的，我就抵抗它。我的真实自我，就是这些"接受"和"拒绝"的累积结果。

- 当我们的行为（受一阶欲望驱动）与我们的深层价值观（二阶欲望）保持一致时，我们就是在真实地生活。
- 推荐系统的核心优化目标是“参与度”（engagement），为此它们严重依赖用户的行为信号（点击、点赞、停留时长）。然而，这些行为信号主要反映的是我们脆弱的、冲动的一阶欲望，而非我们深思熟虑后的二阶欲望。

>(过滤气泡: 侧重于技术层面，指由算法根据用户数据（如浏览历史、点击行为）进行个性化筛选，被动地将用户隔离在与其观点一致的信息流中)

算法如何（有可能）促进“自我理解”（第4节）
积极作用：论文通过郝（Hao） 和BBC记者埃莉·豪斯（Ellie House）的例子，生动地说明了算法的“意外”积极影响。算法根据他们的浏览行为，推荐了大量LGBTQ+内容，这促使他们反思自己的身份，并最终探索和确认了自己的双性恋倾向。在这里，算法扮演了一个“关系性”信息来源的角色，让他们“感觉被看见了”。

核心风险：作者并没有盲目乐观。他用法拉（Farah） 的例子提出了警告。一位进步派穆斯林女性被推荐了大量保守派内容。她可能据此错误地推断“我骨子里就是个保守派”，并因此做出错误的改变。然而，事实上，推荐内容可能仅仅是因为她的地理位置（居住在穆斯林聚居区），而与她的个人行为或身份认同无关。
关键障碍：不透明性（Opacity）：由于算法的“黑箱”特性，用户无法得知推荐背后的真实原因。这迫使用户发展出自己的“算法民间理论”来猜测，而这种猜测往往是错误的，会导致严重的自我误解。

---

变化：视觉上的效果

玩家一开始捏人 -> 直观的看到角色的变化(世界的变化)
捏人(回答问题 -> 角色的位置)

app(真玩家) -> 游戏世界(角色->还是玩家(只是干扰)) -> 意外性
算法的影响度(#1) -> 观看/上桌
...
《算法推荐、信息茧房与“附近的消失”》从信息资源管理学科视角，系统探讨了算法推荐技术如何加剧信息茧房效应，并进一步引发社会层面“附近的消失”这一现象。研究采用“作茧—破茧—成蝶”的递进式框架，分析了用户在网络空间、观念认知和现实生活三个层面遭遇的阶段性困境，并提出了提升算法素养、实现自我觉醒、构建虚实共生场域和推动技术向善等解决路径。
https://dik.whu.edu.cn/jwk3/tsqbzs/EN/Y2025/V42/I2/156

玩家一觉起来发现邻居和周围设施按照app全变化了。
